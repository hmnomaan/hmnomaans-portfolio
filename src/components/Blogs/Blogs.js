...
const Blogs = () => {
    return (
     ...
     data-aos-duration="3000"className="bg-white p-4" ><h2 className="text-white"><img width="300px" height="250px" src={react} alt="" /> </h2>
        ...
        <div className="col-md-4 col-sm-12 mt-3">
          <div className="d-flex align-items-center justify-content-center">
            <div>
            <Card data-aos="flip-right"
     data-aos-duration="3000"className="bg-white p-4" ><h2 className="text-white"><img width="300px" height="250px" src={reactVue} alt="" /> </h2>
        ...
        <div className="col-md-4 col-sm-12 mt-3 ">
          <div className="d-flex align-items-center justify-content-center">
            <div>
            <Card data-aos="flip-right"
     data-aos-duration="3000"className="bg-white p-4" ><h2 className="text-white"><img width="300px" height="250px" src={flutterReact} alt="" /> </h2>
